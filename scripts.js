...
function Card(props) {
    return React.createElement("div", {className: "Person-info"}, [
        React.createElement("h2", null, "id : ", [props.id]),
        React.createElement("h2", null, "Firstname : ", [props.firstname]),
        React.createElement("h2", null, "Lastname : ", [props.lastname]),
        React.createElement("h2", null, "age : ",[props.age]),
        React.createElement("h2", null, "Job : ", [props.job]),
...
function App() {
    return React.createElement("main", { className: "cont"}, [
